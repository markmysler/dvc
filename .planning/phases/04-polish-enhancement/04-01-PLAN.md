...
must_haves:
  ...
  artifacts:
    ...
    - path: "scripts/validate-challenge.js"
  ...
  key_links:
    ...
    - from: "scripts/validate-challenge.js"
      to: "api/validation/"
...
<task type="auto">
  ...
  <verify>npm list ajv && find api/validation -name "*.js" | wc -l | grep -q "3" && test -f scripts/validate-challenge.js</verify>
...
Test validation system: `node scripts/validate-challenge.js challenges/definitions/challenges.json`
</verification>
